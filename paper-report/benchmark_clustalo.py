...
with open('results.csv', 'w') as out_file:
    ...
    for name, benchmark in instances.items():
        ...
        for instance in benchmark:
            ...
            p = subprocess.Popen(['/usr/bin/time', '-f', '%e %M', '../clustalo', '-i',instance, '-o', output(instance), '--outfmt=msf', '--threads=8','--MAC-RAM=48000','--iterations=2'],
            ...
            csv_out.writerow(('clustalo', instance, time, ram, SP, TC))
            counter += 1
