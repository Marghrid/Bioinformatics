...
{\centering \subfloat[\label{fig:count-comparison1}]{\includegraphics[width=\maxwidth]{figure/count-comparison-1} }\newline
...
{\centering \subfloat[a\label{fig:mds1}]{\includegraphics[width=\maxwidth]{figure/mds-1} }\newline
\subfloat[b\label{fig:mds2}]{\includegraphics[width=\maxwidth]{figure/mds-2} }\newline
\subfloat[c\label{fig:mds3}]{\includegraphics[width=\maxwidth]{figure/mds-3} }
