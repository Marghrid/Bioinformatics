...
Analysing the figure we can see that, in general, samples from normal tissues have a higher/lower library complexity than sample from diseased tissues, i.e.,
