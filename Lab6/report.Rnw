...
\todo{RMBB: say something about histogram of the normalised read counts (not really flatter)}
...
\todo{RMBB: say something about \autoref{fig:mds}.}
...
\todo{RMBB: write somthing about \autoref{fig:mds-2}.}
...
kable(topTable(eBfit,coef=2), format = "latex", booktabs = TRUE, caption = "My table", table.envir = "table*")
@
