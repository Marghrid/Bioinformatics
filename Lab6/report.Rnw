...
To confirm that hypotesis, we plotted a (Receiver Operating Characteristic) ROC curve
...
<<estrogen, fig.pos='ht', fig.width=4.5, fig.height=2.5, fig.ncol=1, fig.align='center', fig.cap="Relation between ESR1/ESR2 expression and the presence of estrogen receptors.", fig.subcap=c('a', 'b'), warning=FALSE>>=
...
<<progesterone, fig.pos='ht', fig.width=4.5, fig.height=2.5, fig.ncol=1, fig.align='center', fig.cap="Relation between PGR expression and the presence of progesterone receptors.", fig.subcap=c('a', 'b'), warning=FALSE>>=
...
<<her2, fig.pos='ht', fig.width=4.5, fig.height=2.5, fig.ncol=1, fig.align='center', fig.cap="Relation between ERBB2 expression and the presence of HER2 protein.", fig.subcap=c('a', 'b'), warning=FALSE>>=
...
autoplot(km_fit, conf.int.alpha=0.05, ylab="survival")+ scale_color_brewer(palette="Dark2") + scale_fill_brewer(palette="Dark2") + theme_classic()
@
